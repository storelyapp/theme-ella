class CursorFixed extends HTMLElement {
  ...
  onEnterButton() {
    const buttons = document.querySelectorAll(
      ".button, .button *, button, select, a, .glyphicon, .slick-arrow, .cartTool-item, .arrow-icon-scroll, .recently-viewed-icon"
    );
    buttons.forEach((btn) => {
    ...
    const cardProduct = document.querySelectorAll(
      ".card-title, .media, .dropdown-label, .card-media, .card-compare"
    );
  ...
  onLeaveButton() {
    ...
    const cardProduct = document.querySelectorAll(
      ".card-title, .card-title, .media, .dropdown-label, .card-media, .card-compare"
    );
    cardProduct.forEach((btn) => {
      btn.addEventListener("pointerout", (e) => {
        if (
