    ...
    onScroll() {
        ...
        if (windowWidth < 1025) {
            if (scrollTop > offsetScroll) {
                ...
                // if(document.querySelector('.section-header-mobile').classList.contains('shopify-section-header-sticky')){
                ...
                if(document.querySelector('.section-header-mobile').classList.contains('shopify-section-header-hidden')){
                    this.style.top = 0;
                } else if(document.querySelector('.section-header-mobile').classList.contains('shopify-section-header-sticky') && document.querySelector('.section-header-mobile').classList.contains('scrolled-past-header')) {
                    var height = document.querySelector('.header-mobile').offsetHeight;
                    this.style.top = `${height}px`;
                }
            } else{
